...
// Snapshot tool - Make this the primary snapshot tool for the project
import * as SnapshotTool from './snapshot.js';

// Re-export snapshot functions with unique names to avoid conflicts
export const snapshotCreate = SnapshotTool.createSnapshot;
export const snapshotList = SnapshotTool.listSnapshots;
export const snapshotRestore = SnapshotTool.restoreSnapshot;
